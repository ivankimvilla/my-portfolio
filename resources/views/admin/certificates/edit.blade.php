    ...
    <div class="cert-card">
        <form method="POST" action="{{ route('admin.certificates.update', $certificate) }}" class="cert-form" enctype="multipart/form-data">
            ...
            <div class="cert-btns">
                ...
                <form method="POST" action="{{ route('admin.certificates.destroy', $certificate) }}" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this certificate?')">
                    @csrf
                    @method('DELETE')
